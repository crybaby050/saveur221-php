...
<head>
    ...
    <title>Connexion · Saveur221</title>
    ...
    <div class="flex min-h-screen flex-col md:h-screen md:flex-row">
        ...
        <div class="relative flex flex-1 items-center justify-center overflow-hidden bg-ivoire px-11 py-12">
            ...
            <div class="relative w-full max-w-[360px]" style="z-index:1;">
                ...
                <h1 class="mb-1 text-center font-voice text-2xl font-medium text-charbon">Connexion</h1>
                <p class="mb-7 text-center text-sm text-gris-chaud">Accédez à votre espace Saveur221</p>
                ...
                <p class="mt-5 text-center text-sm text-gris-chaud">
                    Pas encore de compte ? <a href="/inscription" class="font-medium text-bordeaux hover:underline">S'inscrire</a>
                </p>

                <div class="mt-6 h-px bg-or-clair"></div>
