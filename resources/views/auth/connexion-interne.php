...
<head>
    ...
    <title>Connexion — Espace interne · Saveur221</title>
    ...
    <div class="flex min-h-screen flex-col md:h-screen md:flex-row">
        ...
        <div class="relative min-h-[220px] md:min-h-0 flex-1 overflow-hidden bg-charbon">
            ...
            <div class="absolute inset-x-12 bottom-12">
                <p class="mb-1.5 font-voice text-2xl font-medium text-ivoire">Saveurs authentiques</p>
                <p class="text-sm tracking-wide text-or-clair">expérience unique</p>
            </div>
        </div>
        ...
        <div class="relative flex flex-1 items-center justify-center overflow-hidden bg-ivoire px-11 py-12">
            ...
            <svg
                aria-hidden="true"
                viewBox="0 0 24 24" fill="none" stroke="#C9A45C" stroke-width="1"
                style="position:absolute; top:24px; right:28px; width:44px; height:44px; opacity:0.12; z-index:0;"
            >
                <path d="M8 22h8" stroke-linecap="round"/>
                <path d="M12 15v7" stroke-linecap="round"/>
                <path d="M12 15a5 5 0 0 0 5-5c0-2-.5-4-2-8H9c-1.5 4-2 6-2 8a5 5 0 0 0 5 5Z" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>

            <svg
                aria-hidden="true"
                viewBox="0 0 24 24" fill="none" stroke="#7A2334" stroke-width="1"
                style="position:absolute; bottom:28px; left:32px; width:38px; height:38px; opacity:0.10; z-index:0;"
            >
                <path d="M17 8h1a4 4 0 1 1 0 8h-1" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M3 8h14v9a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4Z" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M6 2v2M10 2v2M14 2v2" stroke-linecap="round"/>
            </svg>
            ...
            <div class="relative w-full max-w-[360px]" style="z-index:1;">
                ...
                <h1 class="mb-1 text-center font-voice text-2xl font-medium text-charbon">Espace interne</h1>
                <p class="mb-7 text-center text-sm text-gris-chaud">Gérant et administrateur</p>
                ...
                <form method="post" action="/interne/connexion" class="flex flex-col">
                    ...
                    <div class="mb-4" style="position:relative;">
                        <svg
                            ...
                            style="position:absolute; left:13px; top:50%; transform:translateY(-50%); width:18px; height:18px;"
                        >
                        ...
                        <input
                            ...
                            id="email"
                            name="email"
                            placeholder="prenom.nom@saveur221.sn"
                            required
                    ...
                    <div class="mb-6" style="position:relative;">
                        ...
                        >
                            ...
                            <path d="M8 10V7a4 4 0 0 1 8 0v3" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        <input
                            type="password"
                            id="mot_de_passe"
                    ...
                    <button
                        type="submit"
                        class="h-[46px] rounded-md bg-bordeaux text-sm font-medium tracking-wide text-ivoire transition-colors hover:bg-bordeaux-sombre"
                    >
                        Se connecter
                    </button>
                </form>

                <div class="mt-8 h-px bg-or-clair"></div>
                <p class="mt-3 text-center text-[11px] text-gris-chaud">Saveur221 — saveurs authentiques, expérience unique</p>
